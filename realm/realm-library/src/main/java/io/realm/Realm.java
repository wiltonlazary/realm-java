...
public final class Realm extends BaseRealm {
    ...
    public RealmAsyncTask executeTransaction(final Transaction transaction, final Transaction.Callback callback) {
        return executeTransactionAsync(transaction, new Transaction.OnSuccess() {
            @Override
                ...
                try {
                    ...
                    if (handler != null
                        ...
                        if (onSuccess != null && transactionCommitted) {
                            asyncTransactionCallbacks.add(new Runnable() {
                                @Override
                                public void run() {
                                    onSuccess.onSuccess();
                                }
                        ...
                        if (!handlerController.threadContainsAsyncQueries()) {
